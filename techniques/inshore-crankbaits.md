...
- **Moving tide over bay flats, eelgrass, mooring cans, channel edges** — the
  power-fishing pass (spotted bay bass).
...
- **Treble-to-single swap for kelp fishing (Garrett, Owner Hooks,
  ...
  competitive saltwater bass anglers fishing hard baits **in the kelp**
  (calico bass) replace the stock treble hooks with a **single wire
  replacement hook** designed specifically as a treble replacement (not a
  generic single hook) — its eyelet is arranged so it hangs the right way
  rather than sideways. Stated reasons: it **snags the kelp far less** than a
  treble, and it carries a **bigger gap**, which the speaker credits with a
