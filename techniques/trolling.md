...
channel — medium confidence): a half-day
[striped marlin](../species/striped-marlin.md) trolling stop. The whole program
— the short-and-tight spread and its lure roster, the troll-downhill sun rule,
the jig/prop-wash watch, the 120 ft sounder setting, the
one-hookup-per-five-or-six conversion rate, the tanker-lanes/277 run legs, the
temperature break and the ~160 lb fish — is on
[striped marlin — trolling](../species/striped-marlin-trolling.md); see
[bait-and-switch](bait-and-switch.md) for the dropback mechanics.
...
- [Evidence — Current Diagnostics](../conditions/evidence/current-diagnostics.md)
