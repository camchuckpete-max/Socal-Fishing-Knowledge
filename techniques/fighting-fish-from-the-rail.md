...
- Once past the fish's initial run and starting to work it back, bring the
  rod onto/against the rail and let the rail support and brace it, rather
  than holding the rod's load entirely with arms and body.
...
- [Two-Speed Reel Technique — Low-Gear Grind vs. Pump-and-Reel](two-speed-low-gear-fight.md)
  ...
  that technique assumes this rail-bracing baseline and changes the reel and
  drag side of the fight, not the rail-bracing itself.
...
- [Rail etiquette](rail-etiquette.md) — same channel/series; knowing your
  neighbors and communicating with them so simultaneous fights like these
  don't tangle.
