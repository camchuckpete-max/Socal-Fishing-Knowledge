...
# Wahoo Bomb & Raider Jig — Cast-and-Burn

The **wahoo bomb** and the **Raider jig** are named as **the two most-used
lures for wahoo** (Searcher Sportfishing, `-62xDo4UQzo`, 2020-01-30) —
a **cast-and-burn** presentation on wire leader, distinct from trolling the
same bomb-style lure behind the boat. Execution only; species pattern and
where this fits among wahoo's other techniques routes from
...
- **Conflict, not reconciled — cast vs. troll for the same bomb lure:** at
  ...
  ratio on wahoo's back-half strike (StokedOnFishing, `97clKtVsEOs`) — see
...
- Attach the lure with a piece of **seven-strand or single-strand wire**,
  finished with **a wire twist** and either a **ring or a swivel** at the top
...
- **Rod:** about **9 ft**, a **Cal Star** — squarely the
  [jig-stick class](../tackle/gear-classes.md) (8–10 ft, moderate/fast,
  ~25–60 lb) already documented for surface iron.
- **Reel:** a **star-drag** conventional — captions render "Shimano toy and
  reel," read as **Shimano Torium** (a common Cal Star pairing in this
  fishery); not confirmed by name, **asr-uncertain**. Stated requirement: a
  **mid-to-higher retrieve ratio**, so the lure can be wound fast through the
  water.
