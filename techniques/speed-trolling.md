...
- Pull the lure at **13 to 15 knots** — the speed the Mad Mac class is built to
  track at. Too slow and the bait stops swimming and rolls out.
...
- A **bulky terminal connection** (big snap swivel) that impedes the lure and
  kills its swimming action at speed.
- Leaving the **single J** on the back — swap to a treble to hold short-strikers.
