...
- **Weight rule: ~1 g per foot of depth** for a speed jig (vs ~1.5 g/ft for
  [slow-pitch](slow-pitch-jigging.md)) — enough to punch down and stay vertical.
- Stay **directly up and down.** This is yo-yo logic with a lighter, darting jig:
  drop straight to the calling depth, then rip it up in fast, continuous sweeps.
- **Boat position (night sportboat drill):** when the boat stops on a spot, don't
  run to the stern and drop with the crowd — your line **scopes out** and on the
  300 ft mark your jig is only ~80 ft down. Instead stay forward, **throw up-current
...
- **Dropping off the stern** — the line scopes and the jig never reaches the
  called depth. Throw up-current and stay vertical.
- **No depth reference** — unmarked/uncolored braid means you can't put the jig on
