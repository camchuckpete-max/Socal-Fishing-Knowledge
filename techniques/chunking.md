...
The drift-chunking mechanics above assume you're moving with the current; at
anchor over structure the geometry flips. On an anchored boat the current
almost always runs **down the sides of the boat, not off the stern** — chum
tossed off the back drifts away to whoever's anchored downcurrent, not to your
own baits. Instead, **throw the chum as far up-current along the side of the
boat as you can**; by the time it sinks through the water column it settles in
close beside the hull, putting the boat itself — and your bait — inside the
chum line instead of watching it wash off. Cut squid heads, tentacles, and
