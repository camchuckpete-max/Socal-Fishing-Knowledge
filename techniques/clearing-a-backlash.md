---
type: technique
tags: [casting, baitcaster, conventional-reel, backlash, field-repair]
sources: [Vl0BuetK2D0]
confidence: medium
...
- You've just backlashed a baitcasting or conventional reel while casting and
  want to salvage the line already on the spool instead of cutting the
  tangle out.
- Contrast with [avoiding backlash in the first
  place](underhand-casting.md#avoiding-backlash) — lobbing rather than
  whipping the cast, and a light thumb on the spool as the lure lands. This
  note is the recovery once a backlash has already happened.
...
- [Underhand casting — avoiding backlash](underhand-casting.md#avoiding-backlash) —
  the lob-don't-whip prevention habit this note complements from the recovery
  side.
- [Surface iron — the cast](surface-iron-casting.md) — the whipped, hard cast
  on a jig stick that is a common cause of a backlash.
- [Reel & rod maintenance — on-the-water tackle box](../tackle/reel-maintenance.md#on-the-water-tackle-box--field-tools-and-repairs) —
