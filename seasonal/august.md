...
See [foamer casting](../techniques/foamer-casting.md) for the execution.
...
- **Troll sweeping arcs around the bird/bait area** instead of straight-lining
  away from it.
- **Don't troll through the fleet's prop wash.** Work your own arcs around the
  zone.

See [trolling](../techniques/trolling.md), [search and glassing](../planning/search-and-glassing.md),
and [bird reading](../conditions/bird-reading.md).
