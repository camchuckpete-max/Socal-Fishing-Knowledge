...
| locations/ridge-uncle-sam-bank.md | gazetteer | transformed | gaps(6) fc(2) escalate(zone-page-stale-prose, ladder-rung) | new spot page parented to baja-pacific-south.md (no zone exists for this ground); 4 required sections plus a 6-row species table from 12 cites (_r08B4bItAY, tjBeR9tWd4s, ETw_3AFxEcM, 4uNPLknRAQg, it_YYh_8Z-w, uWGGeDOprsE, MPC_OQjvO-o, RNRFrfepiW0, hteLeDIy9Qs, 97clKtVsEOs, 3tQ1_xiqwVU, yMiBtZ7k8-w); no coordinates published (no spot-lists entry, no charted position in the corpus); 450-460 mi / two-day run carried with the Alijos 88-mile fact-check flag; "the Ridge" name collision against the Magdalena Bay bank, the San Diego sword ground and Clemente Ridge written into the lead and ledgered… |
