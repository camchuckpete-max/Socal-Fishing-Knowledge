...
| locations/172-125.md | geo | transformed | gaps:11 stubs:2 fc:0 spots:3 | new zone page under socal-bight (page did not exist): 3 charted marks — the 172/125 pair 6.8 nm apart off Catalina's West End plus the 499 attached on distance 12.6 nm south, left as queued not re-parented. The 499 is the only mark in the corpus and carries two BD reports: the July-2022 predicted holding water for bluefin that slid in between San Clemente and Catalina (Blh2BA-7Ono) and the fall warm-band station spoken of as '499 Zone' (OYOda6T3f-8); 172 and 125 are position-only. New derived geography: all three marks sit on legs of the corpus's above-Clemente block (Cat-Osborn 22.1 nm… |
