...
| locations/socal-bight.md | geo | transformed | gaps:5 stubs:18 | region page written from 16 corpus sources; all 41 census zones listed (18 flagged stubs), 5 gaps flagged incl. the northern Channel Islands minting no zone; parent child-link left to backlinks (guard forbids editing us-waters.md in this unit) |
