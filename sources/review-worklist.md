...
| locations/del-mar-to-imperial-beach.md | gazetteer | skipped | skipped(coastal-stretch alias; no charted position, no single resolvable parent zone) | skipped: multi-zone stretch of mainland coast, not a spot — 'Del Mar to Imperial Beach' names the span from the library's Del Mar spots (32°57.191'N) to its Imperial Beach spots (32°32.300'N–32°34.500'N) and crosses four built zones (oceanside-north-county, la-jolla, point-loma, imperial-beach) with no single resolvable parent and no sources/spot-lists.md entry of its own; the sole harvest cite VpW91AKOFVQ (mainland schools run smaller and markedly more finicky about jig action than a big Coronado Islands school, especially on bigger-grade fish, and need the retrieve dialed in precisely) is… |
