...
| locations/mackerel-bank.md | gazetteer | transformed | gaps(5), stubs(2) | gazetteer page applied with 5 verifier fixes — 3 report-vs-trip date corrections, dropped bluefin-presence + 18 nm parameter recovered, 2 unharvested mentions added, 1 mis-cite re-sourced |
