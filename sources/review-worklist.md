...
| locations/catalina-island.md | gazetteer | skipped | skipped(island-level-alias) | skipped: island-level alias, not a spot — Catalina Island is already published as two zone pages (catalina-island-front-side.md + catalina-island-backside.md, both parent socal-bight.md), so no single resolvable parent zone exists and the spot library carries no 'Catalina Island' spot entry; the island-level harvest claims (late-Oct ~40 yellows, the bonito/bass/rockfish shift, late-May barracuda, squid-bed halibut 60-100+ ft, sheephead, hoop-net lobster 20-30 ft, whitefish, opah, the ~500-fa curve, side-selection by swell) are already carried on those two zone pages plus bight-geography.md… |
