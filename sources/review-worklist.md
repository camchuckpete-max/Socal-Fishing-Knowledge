...
| locations/kidney-bank-63-175.md | geo | transformed | gaps:17 stubs:1 fc:2 spots:2 | new zone page (Kidney Bank (63) / 175) parented to socal-bight, no evidence file; zero direct corpus coverage — neither mark appears in any transcript, note or evidence file, so this is a position-and-ladder page, but unlike its neighbours it has a live borrowed lead: Santa Barbara Island is 5.6 nm south and the documented Nov-2024/Oct-2025 bluefin ground sat 'just northeast of the island', which is this zone's water by position (Kidney Bank 008/5.6 nm and the 175 026/8.8 nm off Landing Cove) — flagged unverifiable and queued in the ledger; ~30 derived distances from the spot library (3.9 nm… |
