...
| locations/san-benito-island.md | gazetteer | transformed | gaps(7) reg-claims(1) | new spot page under cedros-island.md from 9 cites (JaKSGkZ6CAc, SH7zOA9ZF3o, 97clKtVsEOs, ilINTeknKB4, 9D3Oiy0ASzg, lYyi_Yh3S5g, yjwIGFzWO8I, _r_qKX_7080, _r08B4bItAY); 4 skeleton sections plus a 4-row species table (yellowtail 30-40 fathom squid fishery, lingcod/red rockfish 200 ft drift, calico no-detail gap, everything-else gap); no coordinates published (name-only group, no spot-lists entry); name-variant rows san-benito-islands.md, benitos-island.md and cedros-san-benitos.md are aliases of this page/zone and should skip to it |
