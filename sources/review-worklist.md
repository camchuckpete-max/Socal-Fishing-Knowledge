...
| locations/catalina-west-end.md | gazetteer | skipped | skipped(area-level-alias); worklist row locations/catalina-island-west-end.md is the same alias and should skip identically | skipped: area-level alias for the western end of Catalina, not a spot — the West End straddles two published zones (catalina-island-front-side.md and catalina-island-backside.md, each carrying its own "West End" spot group), so no single resolvable parent zone exists; spot-lists carries no "West End" entry and its charted marks (West End Humps 1-3, Johnson Rock, Stony Point, Parsons Landing, Eagle Rock, West Cove) are already published pages; the sole harvest cite zUFbCIWZZMw (tender worked the west end for yellowtail and white seabass on an expected afternoon bite) is already carried in… |
