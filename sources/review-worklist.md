...
| locations/dana-point-harbor.md | gazetteer | skipped | skipped(port/zone-level alias) | skipped: port/zone-level alias, not a spot — Dana Point Harbor IS the port of the published zone page locations/dana-point.md (which explicitly doubles as a port: the 6:00 a.m. fleet/bait-barge clock and the harbour-mouth troll), and has no sources/spot-lists.md entry of its own; the sole harvest cite poqjnb1r1zk (skiff trolled small feathers in a short daisy chain at 5.5 kt south then north of the harbour, casting on the troll bite) is already carried in locations/dana-point.md (What's there bonito row + 'Troll the harbour mouth for bonito, both sides of it' in How it fishes)… |
