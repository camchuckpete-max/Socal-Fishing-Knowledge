...
| 2y0VznL2qk8 | Your Saltwater Guide | tutorial | deep | done | rigging/flying-fish-harness.md; species/bluefin-tuna-trolling.md; techniques/kite-fishing.md: Added wind-driven rubber-flyer-trolled-8.5kt vs dead-flyer-under-kite/balloon decision with deployment/hookset  |
...
| YijeuGOYoVQ | StokedOnFishing | on-the-water | observations-only | done | RECOVERED 2026-08-26 by the geo phase: locations/east-cape.md + locations/evidence/east-cape.md — the anchor note this row was skipped for now exists. Yields the zone's wahoo distance (a mile to a mile and a half offshore), the wahoo-as-primary-target framing, the radio blue-marlin bite (three boats hooked up at once), the beach ATV sight fishery in full (look for the shadow, start after 9:00 for light, erratic splashy retrieve, 12 ft rod / 1.5-2 oz / 3 oz skipped lure, anglers who come for surf alone), sighted roosterfish at 50 lb and 25-30 lb five feet off the sand, the no-pumping wahoo fight, and a 30-year captain tenure. Prior note stands: the ambiguous ASR marlin/sailfish ID is still left unresolved, carried as a fact-check flag rather than an identification |
...
| 3SATCeA3KaU | StokedOnFishing | on-the-water | observations-only | done | species/calico-bass.md; species/yellowtail.md: Observed blocks, Geronimo/Chester's Rock calico->yellowtail brawl, first-light birds push, plug bite; species/calico-bass-surface-iron.md (2026-08-29 relocation: iron detail + bird cue) |
...
| I-QBxuV2p7M | StokedOnFishing | on-the-water | observations-only | done | species/calico-bass.md; species/yellowtail.md; techniques/surface-iron.md; techniques/trolling.md / Cedros day-2 Observed blocks: yellowtail troll blanked at 30ft on 65/80lb gear, diverted to wide-ope; species/calico-bass-surface-iron.md (2026-08-29 relocation: 18-20 ft reef drift, bird cue, white + blue/green colour pair) |
| e73wPONTOJU | StokedOnFishing | on-the-water | observations-only | done | species/bluefin-tuna-trolling.md; species/bluefin-tuna.md; species/dorado.md; species/striped-marlin.md; techniques/flyline.md; techniques/foamer-casting.md / on-the-water observations-only extraction appl |
...
| xzIaUEDklrE | StokedOnFishing | on-the-water | deep | done | lures/mad-mac.md; seasonal/november-december.md; species/bluefin-tuna-trolling.md; techniques/fighting-big-bluefin.md; techniques/trolling.md / on-the-water deep extraction: 6 Observed blocks (Mad Mac setb |
...
| sHnqSIOjTdM | StokedOnFishing | on-the-water | observations-only | done | bait/bait-tanks.md; species/bluefin-tuna-trolling.md; species/bluefin-tuna.md; species/white-seabass.md; species/yellowtail.md; techniques/fighting-big-bluefin.md / on-the-water observations merged as Obse |
...
| elBPRrdkugU | StokedOnFishing | on-the-water | observations-only | done | fish-care/gaffing.md; species/bluefin-tuna-trolling.md; species/bluefin-tuna.md; techniques/trolling.md; tackle/rod-and-reel-selection.md / RECOVERED WITH A CORRECTION, batch-3 Phase 1. The guard reported "protected path touched: profiles/cameron/rods.md", and the Gate B prep pass recorded it as a correct veto — but the extractor never wrote to the profile. It added a link FROM species/bluefin-tuna-trolling.md INTO profiles/cameron/rods.md (to identify a PCH rod model against Cameron's inventory), and link-maintenance.py then generated the reverse backlink inside the profile. Same mechanical class as the source-registry false positive. The underlying content problem was real though: a universal note must not reach into one user's gear list. Corrected on recovery — the rod is now described in class terms (150–200 lb heavy-troll class) with no profile link. Content: spreader-bar trip observations (mixed-speed spread + "dead zone" fuel framing in mph as spoken, 50-wide reels, all-hands gaff readiness on 100–115 lb fish, Huntington Harbor run profile, trip dated August 2022 from on-camera audio despite the 2022-12-22 upload) |
...
| vCskOx6N-XM | StokedOnFishing | on-the-water | deep | done | fish-care/gaffing.md; rigging/flying-fish-harness.md; species/bluefin-tuna-trolling.md; species/bluefin-tuna.md; techniques/fighting-big-bluefin.md; techniques/kite-fishing.md — Tanner Bank bluefin trip: k |
...
| `IdMJnlg_rZk` (Cedros day 1, 2024) | on-the-water | `locations/cedros-island.md`; `species/calico-bass.md` (mid-day mini-iron row); `species/calico-bass-surface-iron.md` (2026-08-29 relocation: 5.5 in beach mini-iron, mid-day filler slot) |
| `2cxeg_AE418` (Cedros day 2, 2024) | on-the-water | `locations/cedros-island.md`; `species/calico-bass.md`; `techniques/surface-iron.md` §decisions; `species/calico-bass-surface-iron.md` (2026-08-29 relocation: "raining calicos" in-tight ground) |
...
| bM2vUS1B-yQ | Your Saltwater Guide | seminar | deep | done | bait/bait-tanks.md; bait/making-bait.md; planning/electronics-and-sounder.md; species/bluefin-tuna-trolling.md; tackle/hooks.md; techniques/chunking.md / seminar/deep extraction, 6 doctrine additions across bait/electronics/trolling/hooks/chunking, all faithful and confidence-correct |
...
| E4CDqBFOaP8 | Tackle Express | tutorial | parameter-skim | done | lures/lucky-craft-flash-minnow.md (new); species/california-halibut.md; techniques/inshore-crankbaits.md; techniques/leadhead-swimbait-retrieve.md / new lure note (trimmed duplication), halibut router update, stub fill; review-pass correction of a misattributed cite for the 10 ft leadhead-vs-hardbait threshold (was pointed at OURS05qEGcA, which does not contain the claim) |
...
- **2026-08-24 (amendment v2.2):** `species/bluefin-trolling.md` →
  `species/bluefin-tuna-trolling.md`, retyped `decision` →
  `species-technique` (the `decision` type is retired; this was its only
  instance). Earlier rows in this log naming `bluefin-trolling` refer to
  that file under its old name — the log is append-only, so they stand.
