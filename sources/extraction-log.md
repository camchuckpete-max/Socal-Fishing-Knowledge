...
| unARAuTgF_A | Dirty Hookers | tutorial | deep | done | rigging/assist-hooks.md; lures/knife-jigs.md / Cesar's hollow-core/swivel assist-hook tying (pt2) merged; solid-ring-vs-swivel tradeoffs, PE-strength/abrasion logic, speed-vs-slow jig bite mechanism |
