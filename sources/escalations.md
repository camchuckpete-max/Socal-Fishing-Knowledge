...
## 2026-08-29T08:04:46Z — locations/banda-bank-todos-santos-island.md — worker-escalate
- run: 33240630796
- reason: Cameron must rule: dissolve the zone (Todos Santos Island -> locations/ensenada.md, Banda Bank -> locations/punta-banda-santo-tomas.md, re-parenting both spot pages and regenerating the census) or keep the census grouping as approved. Separately, locations/ensenada.md:115-117 still says the Banda Bank / Todos Santos Island zone has no page — stale since that page was built, needs fixing either way
