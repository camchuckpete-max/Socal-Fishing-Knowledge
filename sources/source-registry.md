...
`nate-winnicki` both sit on channels whose other voices are unregistered
(Strictly Irons' host; BDOutdoors guests). Same rule as the BDOutdoors channel
