...
[upwelling & turnover](upwelling-and-turnover.md).

## 1. Winter / upwelling regime
...
- **What it fishes like:** a structure-and-water-quality fishery, not a tuna
  fishery — bass on deep structure through the weather, lings shallow in the
  early window, squid-driven island bites where the squid are in. Fishability
  is set by recent wind and rain more than by anything else; see
  [sea state](sea-state.md) and [upwelling & turnover](upwelling-and-turnover.md).

## 2. Warming transition regime
...
- **What it fishes like:** leading-edge fish ahead of the volume (bluefin creep
  north, the first paddy yellowtail with them), squid-zone island yellowtail,
  narrow seeing-not-biting windows. Wind-rollover geography decides which zones
  survive a blow — see [April](../seasonal/april.md) and
  [sea state](sea-state.md).

## 3. Warm stable regime
...
- **Typical-year mapping:** roughly June through September —
  ...
  [September](../seasonal/september.md) (late; volume square).
- **What it fishes like:** the offshore season proper — fish disperse across the
  whole Bight, the [kelp paddy](kelp-paddies.md) program peaks, warm-water
  arrivals (yellowfin, dorado) stack into the late phase, and the
  [moon](moon.md) drives the night and island bites. Yesterday's spot is a weak
  prior in peak dispersal.

## 4. Fall fragmentation regime
...
- **Typical-year mapping:** October into December —
  ...
  off to winter/upwelling as the storms start.
- **What it fishes like:** an everything-season, but scattered — breadth of
  species, low density of any one. Which side of a break, and where the warm
  band condensed to, matter more than spot names; see
  [current structure](current-structure.md) and
