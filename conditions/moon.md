...
The moon phase is a **probability adjustment**, never a gate. These are captain
observations repeated across the full 2022 season cycle, not measurements — treat
them as shifts to your search prior and timing, not as on/off switches.
...
**relocation** event (see below). Encode as probability, not a rule you obey.
...
## Kelp paddies restock at night

Fish move paddy-to-paddy **only in darkness**. A paddy that is dry stays dry all
...
Spring tides fall on the full and new moon; neap tides on the quarters. The moon
window and the tide window therefore stack — a moon window is also a big-swing
tide window. See [tide and slack](tide-and-slack.md).
