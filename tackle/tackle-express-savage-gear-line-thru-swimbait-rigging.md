...
- [Glide Baits](../techniques/glide-baits.md) — execution for hard-bodied
  swimbaits/glide baits generally; this note covers a tackle-prep step
  (getting the mainline through a specific hollow-body model) rather than how
  to fish one, so it sits alongside rather than inside that note.
- [Line & Leader — Braid, Mono, Fluoro by Application](line-and-leader.md) —
  general material doctrine; this is a narrow, product-specific use of light
  mono as a disposable pull-through leader, not a leader/top-shot spec.
