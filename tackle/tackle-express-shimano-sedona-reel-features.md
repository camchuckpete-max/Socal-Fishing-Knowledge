...
- [Shimano Nasci FC — X-Ship, Propulsion Line System, Core Protect vs. the
  ...
  companion clip (uploaded two days later, 2025-01-27) that names these same
  three Sedona features (Hagane gear, Silent Drive, G-Free Body) without
  explaining them, then pitches the Nasci FC as adding X-Ship, Propulsion
  Line [Management] System, and Core Protect on top. This note supplies the
  explanation that clip lacked.
- ["Next-Gen" CI4+ Reel Features — Body, Infinity Drive, Infinity Cross,
  ...
  Vanford — MGL Rotor, CI4+ Body, and Infinity Drive (Tackle
  Express)](tackle-express-shimano-vanford-fa-reel.md) — the same kind of
  unapplied, presenter-stated feature list for other Shimano reels, at the
  same capped-low confidence.
- [Reel & rod maintenance](reel-maintenance.md) — general corrosion-prevention
  and bearing/gear care discipline this reel's Hagane-gear/Silent-Drive
  claims sit alongside as a manufacturing claim, not a substitute for upkeep.
- [Rod & reel selection](rod-and-reel-selection.md) — general application-based
  reel sizing this product sits within, once a size/class is known.
