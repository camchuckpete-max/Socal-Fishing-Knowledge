...
- **Quantifying how often the circle hook still needs a manual assist
  (Tackle Express, `IZHY3RXdyxg`, "Stop Setting the Hook! Why You Need to Use
  Circle Hooks," 2026-03-24; unregistered channel — medium confidence):**
  demonstrated on an **Owner Mutu circle hook**, restates the core mechanism
  above — the circle shape (point bent back toward the shank) is what drives
  it into the **corner of the mouth** on its own, where a J hook instead
  "catch[es] at any point that it can" — and puts a ratio on the don't-swing
  guidance: getting bit on a circle hook, **nine times out of 10** the right
  move is to put the reel in gear, wind the handle, and lift the rod, no
  swing needed; fishing a fly liner or a J hook still calls for a hookset.
  The "nine out of 10" framing is the one new data point here — it implies a
  circle hook occasionally still needs a manual assist, consistent with,
  not new beyond, the self-hooking mechanism already documented above.
  **A second, near-identical Tackle Express short, adding the fly-liner/J-hook
  mechanics the first clip didn't spell out (Tackle Express, `PciIsDkBgj4`,
  "Stop losing fish! The right way to set your hook every time," 2026-03-28 —
  four days after `IZHY3RXdyxg` above, same channel and near-identical
  framing/wording, most likely re-cut footage of the same doctrine rather than
  independent confirmation; unregistered channel — medium confidence):**
  restates the same nine-out-of-10 circle-hook guidance (reel into gear, turn
  the handle, lift the rod — no swing), then gives the fly-liner/J-hook side a
...
**Bait durability as the driver, stated plainly (Tackle Express, `h311A3s-dkY`,
2026-03-29; unregistered channel — medium confidence):** across the three West
Coast staple baits (anchovy, sardine, mackerel), mackerel is the largest and
sturdiest, so a much larger hook goes in with no risk of hurting the bait —
"that bait's going to truck along, no issue." Anchovy, "a much more delicate,
fragile bait," needs the opposite: size down to a smaller, lighter hook so
...
weight** that works — start light and drop to 1/8 or 1/4 oz — so the bait sinks
**slowly through the water column and along the kelp edge**.
[White seabass](../species/white-seabass.md) feed with the mouth out front, not on
...
**A further re-cut, same footage again (Tackle Express, `rd2Ia8HRbSg`, "Don't
let a weak hook ruin your next big catch. Upgrade now.," upload 2026-05-09;
unregistered channel — medium confidence):** a 46-second short, three days
after `9kGpcEHqIUc`, restating the identical Owner ST-66 swap and "catching
more than enough yellowtail... just to be safe... nothing weird like that
happens" wording near-verbatim — the same audio cut a third way, not an
independent sighting; logged here for provenance only.
