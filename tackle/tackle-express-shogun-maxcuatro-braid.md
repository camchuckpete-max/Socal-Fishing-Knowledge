...
- [Line & Leader — Braid, Mono, Fluoro by Application](line-and-leader.md) —
  the first, independent Power Pro Maxcuatro citation (25% thinner, no
  100 ft-metering detail) this note corroborates and extends.
- [Knife / Speed Jigging — depth control & jig calling](../techniques/knife-jigging.md#depth-control--jig-calling) —
  the general 100 ft-metered-braid depth-calling doctrine this product joins.
