...
Two braid-to-leader connection knots that solve different problems. The **FG
knot** wraps the braid around a straight leader under tension and cinches it into
the leader's surface — an extremely low-profile, high-strength join used braid to
thin/strong fluoro. The **Albright** wraps the braid around a loop formed in the
leader and locks it — a fast, flat-lying join that shines going braid to heavier
...
- **FG** — reach for it when the connection must reel through the guides cleanly
  ...
  [flylining](../techniques/flyline.md), [swimbaits](../techniques/swimbaits.md),
  any lure-casting where a bulky knot would bump the tip guide. Best when leader
  diameter is close to or thinner than what the wraps can bite into.
- **Albright** — an all-round braid-to-solid-mono/fluoro knot for the
  [bays](../species/spotted-bay-bass.md) (spotties, [halibut](../species/california-halibut.md)),
