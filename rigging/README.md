...
- [Essential SoCal Knots](essential-knots.md) — The short list of knots that cover a SoCal sport-boat or private-boat day: terminal knots that tie line to a hook or lure (Palomar, San Diego jam, loop knot), a
...
- [Hollow-Core Splice & Serving](hollow-splice-and-serving.md) — Two knotless connections made possible by hollow-core braid, both relying on the same finger-trap principle: braid woven around a buried line clamps tighter as
- [Leadhead Mods & Rigging](leadhead-mods.md) — The leadhead (jig head) is a workhorse for seabass, halibut, yellowtail, bass, and rockfish.
- [Rubber-Band Deep Rig](rubber-band-deep-rig.md) — A way to take an otherwise flylined live bait down to tuna that are holding deep or sounded on the meter: a torpedo sinker is fastened to the line with a rubber
...
- [Tuna Feather Rig](tuna-feather-rig.md) — Rigging a tuna feather — a West Coast trolling staple.
- [Wind-On Leader](wind-on-leader.md) — A wind-on leader is a fluorocarbon (or mono) top shot joined to hollow-core braid without a knot: the leader is threaded *inside* the hollow braid so the braid'
<!-- index:end -->
