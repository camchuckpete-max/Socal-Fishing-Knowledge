...
| Working a glide bait instead of iron — on top or down | [Glide baits](../techniques/glide-baits.md#yellowtail-surface-pop-retrieve-and-a-half-yo-yo-variant) — surface crank-pop cadence, or a half-yo-yo (halfway up, back to bottom, then all the way up) when fish aren't showing | 8 ft parabolic-bend class, 40 lb+ | Pop-retrieve is easier on spinning than baitcast gear per this source; ⚠ single promotional seminar source, low confidence |
