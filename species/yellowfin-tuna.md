...
15–25 lb the average** grade. Yellowfin are markedly **more lure-cooperative
than bluefin**, they want the **warmest × cleanest** water, and a surface
yellowfin bite is a leading indicator: **when yellowfin are up fighting lures,
the bluefin nearby become more cooperative too.**
...
- **Visual sign:** working birds (terns best) and paddies mark the zone; open-
...
- **Bait:** **30 lb flyline class**, circle hooks **2/0 down to size 1** with
  ...
  swim free and hides better. [Gear classes](../tackle/gear-classes.md).
- **Surface lures:** **jig-stick class**; [poppers & stickbaits](../lures/tuna-poppers-and-stickbaits.md)
  and small lead baits in the 120–150 mm range; a light popper for 10–20 lb fish.
- **Troll:** light **troll class**; [tuna feathers & skirts](../lures/tuna-feathers-and-skirts.md)
  and [cedar plugs](../lures/cedar-plug.md) at yellowfin speed (~6–6.5 kt).
...
- **Doctrine (Jordan / BD, private-boat live bait):** when a chummed school won't
  ...
  **slow-trolling a nose-hooked live bait** both locates schools and entices the
  reluctant biters.
- **Cameron (attributed):** in **warm-water years weights chlorophyll / water
  color at least as heavily as SST** and **won't fish "dirty green" water for
  gamefish** — which lines up directly with the warmest × cleanest rule.
  Interested in warm-water arrivals generally (e.g.
  [Pacific crevalle jack](../species/pacific-crevalle-jack.md)) when the water
