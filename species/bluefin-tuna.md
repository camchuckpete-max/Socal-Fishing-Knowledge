...
Pacific bluefin are SoCal's premier big-game target — a multi-year-resident
fishery that runs from **sub-30 lb schoolies to 300 lb+ cows** in the same
season. They present three fundamentally different ways: **sounded deep schools**
(no surface sign, meter-and-jig game), **surface foamers** (visual, run-and-gun
cast-and-wind), and **paddy/kelp fish** mixed with yellowtail and dorado. This
note routes those situations to techniques; the full **trolling** decision table
lives in [bluefin trolling](../species/bluefin-trolling.md).
...
- **Observed** (StokedOnFishing, `rsCAh-QyK60`, 2017-06-06, launched from
  ...
  confidence): a [kite](../techniques/kite-fishing.md)-hooked bluefin, taken
  on a rigged flying-fish lure, weighed **272 lb** at the scale (the crew's
  destination is named on camera as "the parlor club," asr-uncertain on the
  exact name) — called the angler's biggest fish to date.
- **Observed** (StokedOnFishing, `nkJNzdNlm_c`, upload 2015-01-18, trip framed
  on camera as summertime (resolved from the upload date to **summer 2014**),
  roughly **175–180 mi offshore San Diego**, aboard the **Top Gun 80** out of
  **H&M Landing**, captains named on camera as **Bobby Tapp** and **Scott
  Hart** (ASR-uncertain spelling; "Bobby Tapp" matches the captain name
  already logged from this boat's `skRo1z41Dnc` entry above, uploaded one day
  earlier under a different episode title — very likely the same or an
  immediately adjacent trip from this channel's early-2015 Top Gun 80
  coverage, not independent confirmation); unregistered channel,
  sponsor-heavy episode (Simrad, Okuma, Davis Locker, Softsteel
  monofilament) — medium confidence): a full-speed morning bluefin bite on
  cast iron, with grade called out on camera as **couple of 40 lb-class
  fish** among a mixed bag the captain rated only "decent," not what he was
  hoping for. One angler fought a big-bodied fish on **20 lb** line class.
  The trip closed the same day with a separate afternoon yellowfin bite on
  the iron (see [yellowfin tuna](yellowfin-tuna.md#where--when)); the crew's
  sonar-scanning and audio-cue practice from this session is logged in
  [electronics & sounder](../planning/electronics-and-sounder.md). The
  episode previews a following week's footage moving south to "Bonito
  Island" for a yellowtail bite — not covered in this footage, so not
  extracted here.
- **Observed** (StokedOnFishing, `IwxqgocsQTY`, "Intrepid Style 8 Day, part
  ...
  Captain Kevin Osborne, an Okuma-sponsored charter hosted by Tony (a
  soft-steel-line rep running the "Soft Steel Okuma Charters" program, a
  separate person from the angler Garza named below) —
  fished at anchor on a kelp paddy close to home before the boat ran south for
  the rest of the trip; SoCal, exact zone not named on camera; unregistered
  channel, sponsor-heavy episode (Simrad, Okuma, Davies Locker Sportfishing, a
  car dealership, and a monofilament/fluorocarbon line sponsor) — medium
  confidence, sponsor product/brand claims not carried): with the captain
  calling bluefin marking **80 to 150 ft** down, the crew fished two live-bait
  presentations side by side — **butt-hooking** sardines (hooked in the back)
  on a fluorocarbon leader to a circle hook, the crew's stated reasoning being
  that butt-hooking dives the bait, which you want "when the blue fin are not
  going full stream" (not feeding hard up top); and, on a separate rod, a
  sardine **nose-hooked** and fished on a **2 oz sinker** rig on **40 lb**
  line with a fluorocarbon top shot, which also produced a fish — notably
  hooked **on the retrieve**, wound back in "like you're slow trolling it
  back in" rather than on the drop. That second rig/technique detail is
  logged in [sliding sinker](../techniques/sliding-sinker.md#bluefin-nose-hooked-2-oz-sinker-worked-on-the-retrieve-stokedonfishing).
  A separate butt-hooked hookup was lost when the fish "hit it with such
  force" it knocked the hook loose — a stated failure mode of that
...
- **Visual sign:** foamers (surface whitewater), breezers, jumpers, and spots.
  Foamer taxonomy — a **"jacuzzi" (solid circular whitewater) ≈ a bite every
  cast**; spread-out directional feeders are picky, so wait for the circular
...
- **Species-specific sonar signatures with depths:**
  - **Sounded schools (wind up, no surface sign):** "god forbid there's no
  ...
  - **Near-home kelp stop, another mid-column data point (Observed,
    StokedOnFishing, `IwxqgocsQTY`, 2015-10-29 upload, SoCal, exact zone not
    named on camera; medium confidence, unregistered channel, sponsor-heavy
    episode):** anchored on a kelp paddy, the captain called bluefin marking
    **80 to 150 ft** down — deeper than the 50–100 ft Catalina drift-bite
    entry above, shallower than the 30–50 fm sounded-school range — worked
    with butt-hooked and sinker-rigged live bait rather than a jig; full
    rig/tackle detail logged in **Where & when** above.
  ...
  - **Bait shape:** broken, harried, moving bait holds predators; a solid
    unbroken wall usually does not.
  - Full meter method: [electronics & sounder](../planning/electronics-and-sounder.md).
...
- **Foamer:** beefed **jig-stick class** (backbone to lever a deep fish up), 50 lb
  mono top-shot for stretch *or* straight braid; [poppers & stickbaits](../lures/tuna-poppers-and-stickbaits.md),
  [surface iron](../lures/iron-jigs.md), small lead baits, and a soft-plastic
  glide swimbait (Mad Eel class — see [soft-plastic
  swimbaits](../lures/soft-plastic-swimbaits.md)). Popper/stickbait sizing
  also tracks bluefin grade — a lighter pencil profile for smaller gray
  bluefin, a wing/prop-tail stickbait for bigger gray bluefin (same lure
  note).
...
- **Doctrine (high — Erik Landesfeind, dated reports):** the **cool-side-when-
  warm / warm-side-when-cold** break rule; the **76 °F soft ceiling** (a single
  flagged observation that *softens* the ceiling, doesn't move the band); the
  **leading-days-into-full-moon** window; the seasonal geography (July search
  box, September volume square, Nov–Dec Tanner/Cortez night grade).
- **Doctrine (high — Capt. Duane Diego Mellor):** "the one thing you can count on
  is they'll **break every rule** — number one, find the bait." Dirty/chalky
...
- **Conflict — calendar vs water state:** the corpus **year-anniversary prior**
  ...
  ("the calendar date doesn't matter, they follow water temperature and bait").
  Kept side by side ([year-anniversary prior](../seasonal/year-anniversary-prior.md)).
