...
| **Grunion-in-kelp / bait blitz** (even ugly stagnant water) | Match the bait — 7" split-tail slug on a sled/leadhead, every cast | bass class | Overrides water quality entirely; birds stay on top of the moving bait (`OYOda6T3f-8`) |
...
- **Parallel-current exception (kept side by side):** late fall at San Clemente
  ...
  island** — fish used the dirt to ambush against the structure (`Z3rZqy2Pi8E`).
...
- **Bait events trump water quality:** a grunion blitz in ugly, stagnant,
  no-current kelp produced every-cast bass (`OYOda6T3f-8`) — when the bait is there,
