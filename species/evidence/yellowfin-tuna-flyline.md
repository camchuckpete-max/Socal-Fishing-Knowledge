---
type: evidence
parent: ../yellowfin-tuna-flyline.md
tags: [yellowfin, tuna, flyline, live-bait, sardine, private-boat]
sources: [8M4QhL-Qb7E, AIHvJj-paoo, NN5MWeRA28o]
confidence: medium
---

# Evidence — Yellowfin Tuna — flyline

Per-source provenance backing
[yellowfin tuna — flyline](../yellowfin-tuna-flyline.md). One line per
...
doctrine in the parent. Full yellowfin source provenance, including the sources
this page does not draw on — among them the sportboat chum-timing clip
`lxFNVdDhMy4` cited in the parent's "When this is the call" — is in
[yellowfin evidence](yellowfin-tuna.md).

**Confidence note:** the parent is `confidence: medium`. Its spine is a single
BDOutdoors video presented by Jordan Jennings, who is not a registered voice —
BDOutdoors is not blanket-`high` as a channel — so it caps at medium on the
single-mention rule; the two corroborating leader figures come from an
unregistered channel and a promotional segment respectively.
...
- `8M4QhL-Qb7E` (BDOutdoors — Jordan Jennings, "Yellowfin Tuna Tricks & Tips,"
  ...
  before going to strike and winding tight on the circle. The grade framing for
  the same trip (8–10 lb up to 40–50 lb, 15–25 lb the bread-and-butter fish,
  showing under paddies mixed with other schools) stays on the router.
...
- `NN5MWeRA28o` (SearcherSportfishing, "Tackle Tip Thursday Vol. 20,"
  ...
  capped at low confidence. The router carries the same id as its Coronado
  Islands zone stub.
